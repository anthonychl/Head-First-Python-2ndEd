...
def do_search() ->'html':
    ...
    try: #this try/except 's purpose has changed, now is in case something goes wrong with the thread, it wouldnt react to a log_request runtime error in time now
